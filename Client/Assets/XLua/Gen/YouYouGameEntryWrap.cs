...
namespace XLua.CSObjectWrap
{
    ...
    public class YouYouGameEntryWrap 
    {
        public static void __Register(RealStatePtr L)
        {
            ...
            Utils.RegisterFunc(L, Utils.CLS_GETTER_IDX, "YouYouInput", _g_get_YouYouInput);
            ...
            Utils.RegisterFunc(L, Utils.CLS_GETTER_IDX, "ILRuntime", _g_get_ILRuntime);
            ...
            Utils.RegisterFunc(L, Utils.CLS_GETTER_IDX, "ActionOnUpdate", _g_get_ActionOnUpdate);
            Utils.RegisterFunc(L, Utils.CLS_GETTER_IDX, "ActionOnApplicationPause", _g_get_ActionOnApplicationPause);
            ...
            Utils.RegisterFunc(L, Utils.CLS_SETTER_IDX, "ActionOnUpdate", _s_set_ActionOnUpdate);
            Utils.RegisterFunc(L, Utils.CLS_SETTER_IDX, "ActionOnApplicationPause", _s_set_ActionOnApplicationPause);
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _g_get_YouYouInput(RealStatePtr L)
        {
		    try {
                ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			    translator.Push(L, YouYou.GameEntry.YouYouInput);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _g_get_ILRuntime(RealStatePtr L)
        {
		    try {
                ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			    translator.Push(L, YouYou.GameEntry.ILRuntime);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _g_get_ActionOnUpdate(RealStatePtr L)
        {
		    try {
                ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			    translator.Push(L, YouYou.GameEntry.ActionOnUpdate);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
        ...
        static int _g_get_ActionOnApplicationPause(RealStatePtr L)
        {
		    try {
                ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			    translator.Push(L, YouYou.GameEntry.ActionOnApplicationPause);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _s_set_ActionOnUpdate(RealStatePtr L)
        {
		    try {
                ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			    YouYou.GameEntry.ActionOnUpdate = translator.GetDelegate<System.Action>(L, 1);
        ...
        static int _s_set_ActionOnApplicationPause(RealStatePtr L)
        {
		    try {
                ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			    YouYou.GameEntry.ActionOnApplicationPause = translator.GetDelegate<System.Action<bool>>(L, 1);
